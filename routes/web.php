...
// =====================================================
// 📦 Categorías, Productos, Compras y Proveedores
// Acceso: admin y bodeguero
// =====================================================
Route::middleware(['auth', 'Checkrol:admin,bodeguero'])->group(function () {
...
// =====================================================
// 👤 Usuarios y Reportes — solo admin
// =====================================================
Route::middleware(['auth', 'Checkrol:admin'])->group(function () {
    ...
    Route::prefix('reportes_productos')->group(function () {
